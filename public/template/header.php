...
<body>
  <header>
    ...
    <nav class="nav-list">
      <ul>
        <li class="nav-list-item"><a href="http://l-ec.com">Top</a></li>
        <li class="nav-list-item"><a href="http://l-ec.com//route/cart_empty">カートを空にする</a></li>
        <li class="nav-list-item"><a href="http://l-ec.com/route/cart">カートへ</a></li>
